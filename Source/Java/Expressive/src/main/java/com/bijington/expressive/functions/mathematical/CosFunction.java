 ...
 */
public class CosFunction extends FunctionBase {
    @Override
    ...
    public Object evaluate(IExpression[] parameters) throws ExpressiveException {
        ...
        if (value.getClass().equals(Integer.class)) {
            return Math.cos(Integer.class.cast(value));
        }
        else if (value.getClass().equals(Long.class)) {
            return Math.cos(Long.class.cast(value));
        }
        else if (value.getClass().equals(Double.class)) {
            return Math.cos(Double.class.cast(value));
        }
        else if (value.getClass().equals(Float.class)) {
            return Math.cos(Float.class.cast(value));
        }
